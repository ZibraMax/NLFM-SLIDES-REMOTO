!(function (t, e) {
	...
	var c = function (t, e) {
		...
		x = function (t, e) {
			...
			if (
				...
				return r;
			if ("function" == typeof (n = t.valueOf) && !E((r = n.call(t))))
				return r;
			if (
				!e &&
				"function" == typeof (n = t.toString) &&
	...
	(X.exports = function (t, e, n, r) {
		...
		"function" == typeof n &&
			...
			(i = Jt(n)).source ||
				(i.source = Kt.join("string" == typeof e ? e : ""))),
			t !== jt
	...
	var Ae = Yt,
		...
		Re = function (t, e) {
			var n = Le[Ie(t)];
			return (
				n == $e || (n != Oe && ("function" == typeof e ? _e(e) : !!e))
			);
		},
			...
			if ((n = s ? Me : l ? Me[o] || qe(o, {}) : (Me[o] || {}).prototype))
				for (r in e) {
					if (
						...
						!He(s ? r : o + (l ? "." : "#") + r, t.forced) &&
							void 0 !== i)
					) {
						if (typeof u == typeof i) continue;
						Ze(u, i);
					}
					(t.sham || (i && i.sham)) && Ne(u, "sham", !0),
						Ue(n, r, u, t);
				}
		},
		Ke = Z,
	...
	var sn = rn;
	Je({ target: "RegExp", proto: !0, forced: /./.exec !== sn }, { exec: sn });
	var ln,
		cn,
	...
	Un("search", 1, function (t, e, n) {
		return [
			...
			function (t) {
				...
				var o = Wn(i, u);
				return (
					Qn(i.lastIndex, a) || (i.lastIndex = a),
					null === o ? -1 : o.index
				);
			},
		];
		...
		return [
			...
			function (t, r) {
				...
				for (var f = []; ; ) {
					...
					if ((f.push(h), !p)) break;
					"" === String(h[0]) &&
						(s.lastIndex = br(l, Er(s.lastIndex), d));
				}
					...
					function (t, i) {
						...
						for (var f = 0, h = 0, g = []; h < o.length; ) {
							...
							if (
								null === m ||
								(D = $i(
									zi(p.lastIndex + (Li ? h : 0)),
									o.length
								)) === f
							)
								h = _i(o, h, l);
							else {
								if ((g.push(o.slice(f, h)), g.length === d))
									return g;
		...
		{ target: "Array", proto: !0, forced: !Ku },
		{
			slice: function (t, e) {
				...
				if (
					...
					return Qu.call(u, o, s);
				for (
					r = new (void 0 === n ? Array : n)(Wu(s - o, 0)), i = 0;
					o < s;
					o++, i++
				)
					o in u && Hu(r, i, u[o]);
	...
	var Wa =
		...
		Ya = Bn("unscopables"),
		Xa = Array.prototype;
	null == Xa[Ya] && Ga.f(Xa, Ya, { configurable: !0, value: Wa(null) });
	var to = fe.includes,
		eo = function (t) {
			Xa[Ya][t] = !0;
		};
					...
					},
					{
						...
						value: function (t) {
							...
							if (e) {
								...
								(D.items[D.items.length - 1].raw =
									n.trimRight()),
									(D.items[D.items.length - 1].text =
										d.trimRight()),
								...
								for (a = 0; a < y; a++) {
									...
									var k = D.items[a].tokens.filter(function (
											t
										) {
											return "space" === t.type;
										}),
								...
								for (; t; )
									if (
										...
										if ((e = this.tokenizer.escape(t)))
											...
											(e = this.tokenizer.autolink(t, as))
										)
											(t = t.substring(e.raw.length)),
												s.push(e);
										else if (
				...
				lr(t, [
					...
					},
					{
						...
						value: function (t, e) {
							...
							return (
								e || ((this.seen[t] = r), (this.seen[n] = 0)), n
							);
						},
					},
					{
	...
	function ds(t, e, n) {
		...
		try {
			var o = os.lex(t, e);
			return (
				e.walkTokens && ds.walkTokens(o, e.walkTokens), ps.parse(o, e)
			);
		} catch (t) {
			if (
				((t.message +=
	...
	(ds.options = ds.setOptions =
		...
		(ds.use = function () {
			for (var t = arguments.length, e = new Array(t), n = 0; n < t; n++)
				e[n] = arguments[n];
			var r,
				i = Wo.apply(void 0, [{}].concat(e)),
				u = ds.defaults.extensions || {
					renderers: {},
					childTokens: {},
				};
				...
				if (
					(t.extensions &&
						...
						t.extensions.forEach(function (t) {
							...
							t.childTokens &&
								(u.childTokens[t.name] = t.childTokens);
						})),
					t.renderer &&
						(function () {
	...
	return function () {
		...
		function i(t) {
			...
			i &&
				((a.notes = i.innerHTML),
				(a.markdown =
					"string" == typeof i.getAttribute("data-markdown"))),
